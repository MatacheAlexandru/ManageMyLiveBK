          ...
          <MDBModalBody>
            <MDBDropdown className="mb-3">
              ...
              <MDBDropdownMenu className="w-100 p-2 shadow-lg rounded bgMebuDropdown">
                <MDBDropdownItem
                  onClick={() => handleSelectCategory("Zboruri")}
                  className="dropdown-item-custom"
                >
                  Zboruri
                </MDBDropdownItem>
                <MDBDropdownItem
                  onClick={() => handleSelectCategory("Hoteluri")}
                  className="dropdown-item-custom"
                >
                  Hoteluri
                </MDBDropdownItem>
                <MDBDropdownItem
                  onClick={() => handleSelectCategory("Asigurare de călătorie")}
                  className="dropdown-item-custom"
                >
                  Asigurare de călătorie
                </MDBDropdownItem>
                <MDBDropdownItem
                  onClick={() => handleSelectCategory("Concerte")}
                  className="dropdown-item-custom"
                >
                  Concerte
                </MDBDropdownItem>
