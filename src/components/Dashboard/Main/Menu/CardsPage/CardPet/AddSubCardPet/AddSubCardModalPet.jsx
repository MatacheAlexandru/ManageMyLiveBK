          ...
          <MDBModalBody>
            <MDBDropdown className="mb-3">
              ...
              <MDBDropdownMenu className="w-100 p-2 shadow-lg rounded bgMebuDropdown">
                <MDBDropdownItem
                  onClick={() => handleSelectCategory("Vacin Anual")}
                  className="dropdown-item-custom"
                >
                  Vacin Anual
                </MDBDropdownItem>
                <MDBDropdownItem
                  onClick={() => handleSelectCategory("Deparazitare")}
                  className="dropdown-item-custom"
                >
                  Deparazitare
                </MDBDropdownItem>
                <MDBDropdownItem
                  onClick={() => handleSelectCategory("Programare La Doctor")}
                  className="dropdown-item-custom"
                >
                  Programare La Doctor
                </MDBDropdownItem>
                <MDBDropdownItem
                  onClick={() => handleSelectCategory("Tratament")}
                  className="dropdown-item-custom"
                >
                  Tratament
                </MDBDropdownItem>
